      ...
      <a href={`#`}>
        <div className="flex flex-col bg-white border rounded-2xl shadow-lg mx-2 my-5">
          <div className="flex flex-col justify-center items-center px-3 text-yellow-500">
            <div className="mt-3">
              <h2 className="whitespace-nowrap pt-2 text-xl">Detail Asset</h2>
            </div>
            <div className="flex text-center my-5 whitespace-normal text-xs gap-3">
              <div>
                <h2 className="text-[10px]">Keseluruhan</h2>
              ...
              <div>
                <h2 className="text-[10px]">Generate</h2>
                <h2 className="text-xl">0</h2>
                <div className="flex justify-center items-center">
                  <h2>0</h2>
                  <svg
              ...
              <div>
                <h2 className="text-[10px]">Tidak Ada</h2>
                <h2 className="text-xl">0</h2>
                <div className="flex justify-center items-center">
                  <h2>0</h2>
                  <svg
              ...
              <div>
                <h2 className="text-[10px]">Temuan</h2>
                <h2 className="text-xl">0</h2>
                <div className="flex justify-center items-center">
                  <h2>0</h2>
                  <svg
